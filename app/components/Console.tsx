...
const Console: React.FC<ConsoleProps> = ({ logs, onRun, onClear }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full border border-gray-300 rounded overflow-hidden">
      <div className="bg-gray-100 px-3 py-2 border-b border-gray-300 flex items-center justify-between flex-shrink-0">
      ...
      <div
        ref={consoleRef}
        className="flex-1 min-h-0 overflow-y-auto p-4 bg-gray-900 text-sm font-mono"
      >
        {logs.length === 0 ? (
